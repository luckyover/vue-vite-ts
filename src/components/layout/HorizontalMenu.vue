                ...
                <div class="offcanvas offcanvas-end kanban-update-item-sidebar">
                  ...
                  <div class="offcanvas-body pt-4">
                    <ul class="nav nav-pills tabs-line">
                      <li class="nav-item">
                        <button
                          class="nav-link active shadow-none"
                          data-bs-toggle="tab"
                      ...
                      >
                        <form>
                          ...
                          <div class="mb-3">
                            ...
                            <div
                              class="assigned d-flex flex-wrap avatar-group"
                            ></div>
                          </div>
                          <div class="mb-3">
                      ...
                      >
                        <div class="media mb-4 d-flex align-items-start">
                          ...
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-medium">Jordan</span> Left the
                              board.
                            </p>
                        ...
                        <div class="media mb-4 d-flex align-items-start">
                          ...
                          <div class="media-body">
                            <p class="mb-0">
                              ...
                              <span class="fw-medium text-primary">@bruce</span>
                              in a comment.
                            </p>
                        ...
                        <div class="media mb-4 d-flex align-items-start">
                          ...
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-medium">Barry</span> Commented on
                              App review task.
                            </p>
                        ...
                        <div class="media mb-4 d-flex align-items-start">
                          <div class="avatar avatar-sm me-2 flex-shrink-0 mt-1">
                            <span
                              class="avatar-initial bg-label-dark rounded-circle"
                              >BW</span
                            >
                          </div>
                          <div class="media-body">
                        ...
                        <div class="media mb-4 d-flex align-items-start">
                          <div class="avatar avatar-sm me-2 flex-shrink-0 mt-1">
                            <span
                              class="avatar-initial bg-label-danger rounded-circle"
                              >CK</span
                            >
                          </div>
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-medium">Clark</span> assigned task
                              UX Research to
                        ...
                        <div class="media mb-4 d-flex align-items-start">
                          ...
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-medium">Barry</span> Complete all
                        ...
                        <div class="media mb-4 d-flex align-items-start">
                          ...
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-medium">Jordan</span> added task
                        ...
                        <div class="media mb-4 d-flex align-items-start">
                          ...
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-medium">Clark</span> added new
                              board with name
                        ...
                        <div class="media d-flex align-items-center">
                          ...
                          <div class="media-body">
                            <p class="mb-0">
                              <span class="fw-medium">Bruce</span> added new
